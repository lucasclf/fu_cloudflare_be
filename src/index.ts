...
app.route("/v1/campaigns", createCampaignRoutes(createCampaignReadService, createCampaignEntityService, createPcService, createCampaignMemberService, createItemService, createSessionService, createLocationService, createFactionService));
